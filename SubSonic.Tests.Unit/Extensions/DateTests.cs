...
namespace SubSonic.Tests.Unit.Extensions
{
	public class DateTests
	{
		...
		public void DaysAgo_Should_Return_DateTime_AddDays_Neg3_For_3()
		{
			...
			Assert.Equal(then, DateTime.Now.AddDays(-3), new TimeSpan(100));
		}
		...
		public void HoursAgo_Should_Return_DateTime_AddHours_Neg3_For_3()
		{
			...
			Assert.Equal(then, DateTime.Now.AddHours(-3), new TimeSpan(100));
		}
		...
		public void MinutesAgo_Should_Return_DateTime_AddMinutes_Neg3_For_3()
		{
			...
			Assert.Equal(then, DateTime.Now.AddMinutes(-3), new TimeSpan(100));
		}
		...
		public void SecondsAgo_Should_Return_DateTime_AddSeconds_Neg3_For_3()
		{
			...
			Assert.Equal(then, DateTime.Now.AddSeconds(-3), new TimeSpan(100));
		}
