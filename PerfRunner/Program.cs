...
namespace PerfRunner
{
	public class Program
	{
		...
		{
			Console.WriteLine("Selecting 1000 records of 10/each with AR: " + DateTime.Now + " using " + provider.Name);
		...
		static void WriteResult(DateTime startTime)
		{
			TimeSpan ts = DateTime.Now.Subtract(startTime);
			Console.WriteLine(String.Format("End: {0} - Took: {1} minutes {2}.{3} seconds", DateTime.Now, ts.Minutes, ts.Seconds, ts.Milliseconds));
		}
